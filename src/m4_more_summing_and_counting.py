...
Authors: David Mutchler, Dave Fisher, Valerie Galluzzi, Amanda Stouder,
         their colleagues and Zhengshan_Fang.
...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(24)
    answer_from_my_code = factorial(24)
...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 1
    answer = count_cosines_from(8, 8, -2)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(7, 7, 4)
