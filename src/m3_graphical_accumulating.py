...
def draw_parallel_lines(n, point, length, window):
    ...
    # ------------------------------------------------------------------
    for k in range(n):
        left_end_point = rg.Point(point.x, point.y+k*30)
        right_end_point = rg.Point(left_end_point.x + length, point.y+k*30)
        line = rg.Line(left_end_point, right_end_point)
...
def draw_lines(n, point, window):
    ...
    # ------------------------------------------------------------------
    for k in range(n):
        left_point = rg.Point(point.x, point.y)
        right_point = rg.Point(point.x+100, point.y+100-k*(200/(n-1)))
